...
class MyFunctionTest < Minitest::Test
  ...
  def test_divide()
    #We test the zero value for the denominator to avoid the division by zero error
    divide_result = divide( 10, 0 )
    divide_result_two = divide(10, 5)
    assert_nil(divide_result)
    assert_equal(2, divide_result_two)
  end
  ...
  def test_fahrenheit_to_celsius()
    temp_in_celcius = fahrenheit_to_celsius(100)
    assert_equal(37.78, temp_in_celcius)
  end
